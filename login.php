...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/exo-logo.png">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        <div class="login-logo">
            <a href="masuk"><b>EXO Fansite Meeting</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/exo-logo.png" height="60px" width="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
            ...
            <div class="social-auth-links text-center">
                ...
                <div class="row">
                    ...
                    <p class="text-right"> Kembali ke Home,<a href="index.html">klik disini</a></p>
                </div>
            </div>

            <!-- <p style="text-align: center; font-size: 13px;">Hak Cipta &copy; <?= date('Y'); ?> .<?= $row1['nama_app']; ?> by Roya.</p> -->
