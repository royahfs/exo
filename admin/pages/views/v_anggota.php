                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Anggota.php?aksi=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Semester/Prodi <small style="color: red;">* Wajib diisi</small></label>
                                                            <select class="form-control" name="kElas">
                                                                ...
                                                                ?>
                                                                <option value="1/Sistem Informasi">1/Sistem Informasi</option>
                                                                <option value="1/Ilmu Komputer">1/Ilmu Komputer</option>
                                                                <option value="1/Biologi">1/Biologi</option>
                                                                <option value="1/Matematika">1/Matematika</option>
                                                                <option value="1/Fisika">1/Fisika</option>
                                                                <!-- semester 2 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="2/Sistem Informasi">2/Sistem Informasi</option>
                                                                <option value="2/Ilmu Komputer">2/Ilmu Komputer</option>
                                                                <option value="2/Biologi">2/Biologi</option>
                                                                <option value="2/Matematika">2/Matematika</option>
                                                                <option value="2/Fisika">2/Fisika</option>
                                                                <!-- semester 3 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="3/Sistem Informasi">3/Sistem Informasi</option>
                                                                <option value="3/Ilmu Komputer">3/Ilmu Komputer</option>
                                                                <option value="3/Biologi">3/Biologi</option>
                                                                <option value="3/Matematika">3/Matematika</option>
                                                                <option value="3/Fisika">3/Fisika</option>
                                                                <!-- semester 4 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="4/Sistem Informasi">4/Sistem Informasi</option>
                                                                <option value="4/Ilmu Komputer">4/Ilmu Komputer</option>
                                                                <option value="4/Biologi">4/Biologi</option>
                                                                <option value="4/Matematika">4/Matematika</option>
                                                                <option value="4/Fisika">4/Fisika</option>
                                                                <!-- semester 5 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="5/Sistem Informasi">5/Sistem Informasi</option>
                                                                <option value="5/Ilmu Komputer">5/Ilmu Komputer</option>
                                                                <option value="5/Biologi">5/Biologi</option>
                                                                <option value="5/Matematika">5/Matematika</option>
                                                                <option value="5/Fisika">5/Fisika</option>
                                                                <!-- semester 6 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="6/Sistem Informasi">6/Sistem Informasi</option>
                                                                <option value="6/Ilmu Komputer">6/Ilmu Komputer</option>
                                                                <option value="6/Biologi">6/Biologi</option>
                                                                <option value="6/Matematika">6/Matematika</option>
                                                                <option value="6/Fisika">6/Fisika</option>
                                                                <!-- semester 7 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="7/Sistem Informasi">7/Sistem Informasi</option>
                                                                <option value="7/Ilmu Komputer">7/Ilmu Komputer</option>
                                                                <option value="7/Biologi">7/Biologi</option>
                                                                <option value="7/Matematika">7/Matematika</option>
                                                                <option value="7/Fisika">7/Fisika</option>
                                                                <!-- semester 8 -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="8/Sistem Informasi">8/Sistem Informasi</option>
                                                                <option value="8/Ilmu Komputer">8/Ilmu Komputer</option>
                                                                <option value="8/Biologi">8/Biologi</option>
                                                                <option value="8/Matematika">8/Matematika</option>
                                                                <option value="8/Fisika">8/Fisika</option>
                                                                <option disabled>------------------------------------------</option>
            ...
            <form action="pages/function/Anggota.php?aksi=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Semester/Prodi <small style="color: red;">* Wajib diisi</small></label>
                        <select class="form-control" name="kelas">
                            <option disabled selected>-- Harap Pilih Semester dan Prodi --</option>
                            <!-- X -->
                            <option disabled>------------------------------------------</option>
                            <!-- semester 1 -->
                            <option value="1/Sistem Informasi">1/Sistem Informasi</option>
